...
from fa_passages_1_10 import PASSAGES_1_10
from fa_passages_11_20 import PASSAGES_11_20
...
print(f"All 20 Fine Arts passage pairs verified: {len(PASSAGES_20)} pairs (40 passages, 200 questions).")
