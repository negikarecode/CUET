...
from ped_s1_10 import SLOTS_1_10
from ped_s11_20 import SLOTS_11_20
from ped_s21_30 import SLOTS_21_30
from ped_s31_40 import SLOTS_31_40
from ped_passages import PASSAGES_20
...
print("Starting full generation for Physical Education...")
generate_subject_suite(
    subject_key="physical_education",
    subject_prefix="ped",
    out_dir="mock/physical_education",
    slot_specs_40=slot_specs_40,
    passage_specs_20=PASSAGES_20
)
print("Physical Education generation complete!")
