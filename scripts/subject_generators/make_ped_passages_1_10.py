...
out_path = "scripts/subject_generators/ped_passages_1_10.py"
...
P2_M8_QS = [
    ...
    case_q("Biomechanics and Sports", "Momentum Transfer in Batting/Throwing",
     ...
     "Transfer of linear momentum during elastic collisions maximizes the impulse ($F \\times \\Delta t$) imparted to the ball."),
    case_q("Biomechanics and Sports", "Cricketer Soft Hands Catching Biomechanics",
     ...
     "To increase the impact duration ($\\Delta t$), thereby reducing the rate of change of momentum and minimizing impact force on the hands",
     ...
     "Impulse equation ($F \\times \\Delta t = \\Delta p$): extending impact time reduces the peak contact force, preventing hand injury.")
]
...
P1_M10_TXT = (
    ...
    "governing horizontal distance ($R \\propto v^2$). On flat ground where release and landing heights are identical, the theoretical optimal launch angle is 45°. "
...
P1_M10_QS = [
    case_q("Biomechanics and Sports", "Dominant Factor in Projectile Distance",
     ...
     "Initial Release Velocity (because distance is proportional to velocity squared, $R \\propto v^2$)",
     ["The color of the projectile", "The humidity of the air alone", "The length of the thrower\'s hair"],
     "Range scales quadratically with release speed ($R \\propto v^2$); velocity gains produce the largest increases in throwing distance."),
