...
from cs_s1_10 import SLOTS_1_10
from cs_s11_20 import SLOTS_11_20
from cs_s21_30 import SLOTS_21_30
from cs_s31_40 import SLOTS_31_40
from cs_passages import PASSAGES_20
...
print("Starting full generation for Computer Science / Informatics Practices...")
generate_subject_suite(
    subject_key="computer_science",
    subject_prefix="cs",
    out_dir="mock/computer_science",
    slot_specs_40=slot_specs_40,
    passage_specs_20=PASSAGES_20
)
print("Computer Science / Informatics Practices generation complete!")
