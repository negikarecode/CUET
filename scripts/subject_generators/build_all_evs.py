...
from evs_s1_10 import SLOTS_1_10
from evs_s11_20 import SLOTS_11_20
from evs_s21_30 import SLOTS_21_30
from evs_s31_40 import SLOTS_31_40
from evs_passages import PASSAGES_20
...
print("Starting full generation for Environmental Studies...")
generate_subject_suite(
    subject_key="environmental_studies",
    subject_prefix="evs",
    out_dir="mock/environmental_studies",
    slot_specs_40=slot_specs_40,
    passage_specs_20=PASSAGES_20
)
print("Environmental Studies generation complete!")
